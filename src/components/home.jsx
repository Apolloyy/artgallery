...
export default function Home() {
  return (
    <div className="w-full h-min flex gap-8 lg:justify-center justify-evenly items-start py-8">
      <span className="text-cod-gray-200 font-hepta lg:text-4xl text-2xl lg:w-32 w-10">
        The <b>art</b> gallery.
      </span>
      <div className="flex flex-col gap-4">
        <div className="flex lg:flex-row flex-col items-center gap-4">
          <Link to={"/baco"}>
            <img
              src={Caravaggio}
              className="md:w-96 md:h-[488px] w-48 h-[244px] border border-cod-gray-900 relative"
            />
          ...
          <div className="flex flex-col items-center gap-4">
            <Link to={"/nascer"}>
              <img
                src={Caspar}
                className="md:w-96 md:h-[236px] w-48 h-[118px] border border-cod-gray-900 relative"
              />
